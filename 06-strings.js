...
console.log(greeting.indexOf("OOO"))
console.log(greeting.indexOf("sadsdd"))
console.log(greeting.includes("Hola")) // Incluye
console.log(greeting.includes("Brais"))
console.log(greeting.includes("aaaaa"))
console.log(greeting.slice(0, 10)) // Sección
console.log(greeting.replace("Brais", "bbbb")) // Reemplazo
